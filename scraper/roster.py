...
votes page: the 12 district councilors plus the Mayor. District and
headshot data are fixed public facts not exposed by the votes page itself,
so they're maintained here. Keyed by the exact name string as it appears
on the votes page. District 0 marks the Mayor (citywide, not one of the
4 geographic council districts).
"""
